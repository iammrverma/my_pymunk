...
def create_swing(space, width, height):
    rotation_center_body = pymunk.Body(body_type=pymunk.Body.STATIC)
    rotation_center_body.position = (width / 2, height / 2)
    body = pymunk.Body()
    body.position = (width / 2, height / 2)
    line = pymunk.Segment(body, (0, 0), (250, 0), 5)
...
def main(win, width, height):
    ...
    create_swing(space, width, height)
